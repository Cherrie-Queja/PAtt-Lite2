...
def label_smooth(pred,
    ...
    loss = weight_reduce_loss(
        loss, weight=weight, reduction=reduction, avg_factor=pred.shape[0])
...
# pred = torch.tensor([[0.2, 0.6, 0.1, 0.1], [0.8, 0.1, 0.1, 0], [0.2, 0.6, 0.1, 0.1], [0.8, 0.1, 0.1, 0]])
#
# loss = LabelSmoothLoss(0.1, 4)
# l = loss(pred, target)
# print(l)
# target = torch.tensor([1, 0,1,0])
